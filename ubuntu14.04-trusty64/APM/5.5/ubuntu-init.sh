...
PHP_VERSION="5" # ubuntu 14.04의 기본 PHP버전 5.5.9
...
sudo apt-get install -y --force-yes php${PHP_VERSION}-common php${PHP_VERSION} php${PHP_VERSION}-dev php${PHP_VERSION}-json php${PHP_VERSION}-cli libapache2-mod-php${PHP_VERSION} php${PHP_VERSION}-mysql php${PHP_VERSION}-curl php${PHP_VERSION}-gd php${PHP_VERSION}-mcrypt
Update
